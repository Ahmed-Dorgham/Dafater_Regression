...
public class ComparingCreditNotesTestSalesModule extends BaseTest {
    Random random;
    int randomNumber;
    String itemCode;
    ...
    public void TC01_comparingCreditNotesDataAtListViewSalesModule() throws InterruptedException, IOException {
        ...
        String valueOfPaymentReceivedAtCreditNotesListViewAfterSyncing = creditNotesListPageObj.getTotalPaymentReceivedAmountOfCreditNotesAfterSyncing();
//
