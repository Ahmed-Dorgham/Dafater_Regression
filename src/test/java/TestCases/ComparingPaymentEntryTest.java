...
public class ComparingPaymentEntryTest extends BaseTest {
    Random random;
    int randomNumber;
    String itemCode;
    ...
    public void TC01_comparingNumberOfPaymentEntry() throws InterruptedException, IOException {
        ...
        String numberOfAllPaymentEntriesBeforeSyncing = paymentEntryListPageObj.getNumberOfAllPaymentEntryBeforeSyncing();
