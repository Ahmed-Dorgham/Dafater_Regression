...
//       Allure.step("Verify the name of sales invoice  ");
       ...
       Allure.step("actual text is  " + getWebElement(purchaseInvoiceNameInsideDebitNote).getAttribute("data-value") + "  and expected text is  " + expected);
...
//        scrollToSpeceficElement(saveAndSubmitBtn);
       Allure.step("save and submit debit Note ");
