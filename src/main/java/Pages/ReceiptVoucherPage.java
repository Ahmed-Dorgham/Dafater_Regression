...
public class ReceiptVoucherPage extends MainPage {
    ...
    private By newReceiptVoucherTitle = By.xpath("//*[contains(@title,'سندات الدفع جديد')]");
    private By customerFieldReceiptVoucher = By.xpath("(//*[contains(@id,'party')])[4]");
    private By accountFieldReceiptVoucher = By.xpath("(//*[contains(@id,'paid_to')])");
    ...
    private By customersListReceiptVoucher = By.xpath("(//*[contains(@data-target,'party')and @placeholder=' ']/following-sibling::ul)");
    private By accountsListReceiptVoucher = By.xpath("(//*[contains(@id,'paid_to')and @placeholder=' ']/following-sibling::ul)");
    private By customerOptReceiptVoucher = By.xpath("((//*[contains(@data-target,'party')and @placeholder=' ']/following-sibling::ul)/li)[1] " +
            "| ((//*[contains(@data-target,'party')and @placeholder=' ']/following-sibling::ul)/div/p/strong)[1]");
    private By accountOptReceiptVoucher = By.xpath("((//*[contains(@id,'paid_to')and @placeholder=' ']/following-sibling::ul)//p)[1] ");
    private By amountInputFieldReceiptVoucher = By.xpath("(//*[contains(@id,'paid_amount')])");
    ...
    private By accountInputField = By.xpath("//*[contains(@id,'due_date')]");
    ...
    public void applyCompleteWriteOff(String amount) throws InterruptedException {
...
//        getWebElement(writeOffSection).click();
        ...
        getWebElement(writeOffAmountField).sendKeys(amount);
    ...
    public String getTotalOutstandingAmountValue() throws InterruptedException {
        ...
        System.out.println("otal outstanding amount value  after apply write off is " + getWebElement(totalOutstandingAmountValue).getAttribute("textContent"));
        Allure.step("otal outstanding amount value  after apply write off is " + getWebElement(totalOutstandingAmountValue).getAttribute("textContent"));
        return getWebElement(totalOutstandingAmountValue).getAttribute("textContent");
    }

    public void enterValidDataIntoReceiptVoucherPage() throws InterruptedException {
//        By selectedItem = By.xpath("((//*[contains(@data-target,'Item')and @placeholder='صنف']/following-sibling::ul)//div//p[@title='" + itemName + "'])");

        waitUntilElementToBePresent(newReceiptVoucherTitle, GeneralConstants.minTimeOut);
        Allure.step("select  customer ");
        waitUntilOverlayDisappear(overlay, GeneralConstants.freezeTimeOut);
        getWebElement(customerFieldReceiptVoucher).click();
        if (tryToGetWebElementV(customersListReceiptVoucher) == GeneralConstants.FAILED) {
            getWebElement(customerFieldReceiptVoucher).click();
        }
//        clickByJs(getWebElement(customerFieldSalesInvoice));
        waitUntilElementToBePresent(customersListReceiptVoucher, GeneralConstants.minTimeOut);
        waitUntilElementToBeClickable(customerOptReceiptVoucher, GeneralConstants.minTimeOut);
        getWebElement(customerOptReceiptVoucher).click();
        scrollToSpeceficElement(accountFieldReceiptVoucher);
        Allure.step("enter account  ");
        getWebElement(accountFieldReceiptVoucher).click();
        if (tryToGetWebElementV(accountsListReceiptVoucher) == GeneralConstants.FAILED) {
            getWebElement(accountFieldReceiptVoucher).click();
        }
//        clickByJs(getWebElement(customerFieldSalesInvoice));
        waitUntilElementToBePresent(accountsListReceiptVoucher, GeneralConstants.minTimeOut);
        waitUntilElementToBeClickable(accountOptReceiptVoucher, GeneralConstants.minTimeOut);
        getWebElement(accountOptReceiptVoucher).click();

        Allure.step("enter amount  ");
        waitUntilElementVisibility(amountInputFieldReceiptVoucher,GeneralConstants.minTimeOut);
...
//        clickByJs(getWebElement(customerFieldSalesInvoice));
        ...
        getWebElement(accountInputField).sendKeys(dueDate);
        Allure.step("Scroll down to item field ");
        scrollToSpeceficElement(totalAmountLabel);
        Allure.step(" select item  ");
        clickByActions(itemCodeField);
...
//        getWebElement(updateStockBtn).click();
    ...
    public void clickOnSaveAndSubmitBtn() {
        ...
        waitUntilElementToBeClickable(yesBtn, GeneralConstants.minTimeOut);
        getWebElement(yesBtn).click();
        waitUntilElementToBePresent(submittedStatus, GeneralConstants.minTimeOut);
    }
