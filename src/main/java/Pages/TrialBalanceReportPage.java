...
public class TrialBalanceReportPage extends MainPage {
    private String dataMigrationTitle = "data migration";
    // private WebDriver driver ;

    public TrialBalanceReportPage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    private By companyField_4 = By.xpath("(//*[contains(@data-fieldname,'company') and contains(@class,'input-with-feedback form-control ui-autocomplete-input')  ])");
    private By yearField_4 = By.xpath("(//*[contains(@data-fieldname,'fiscal_year') and contains(@class,'input-with-feedback form-control ui-autocomplete-input')  ])");
    private By levelField_4 = By.xpath("(//*[contains(@title,'إختر')])[1]");
    private By levelField_5 = By.xpath("//*[contains(@data-fieldname,'account_level')]");
    private By wareHouseInputField_5 = By.xpath("//*[contains(@data-fieldname,'warehouse')]/div/ul/li/input");
    private By chosenCompany = By.xpath("(//*[contains(@class,'ui-autocomplete ui-front scroll-styler ui-menu ui-widget ui-widget-content ui-corner-all')]/li/a/span)[1]");
    private By chosenCompany_5 = By.xpath("(//div[@data-fieldname='company']/div/div/ul/div)[1]/p");
    private By chosenYear = By.xpath("(((//*[contains(@class,'ui-autocomplete ui-front scroll-styler ui-menu ui-widget ui-widget-content ui-corner-all')]/li)[1]/a)[1]/span)[1]");
    ...
    private By accountLevelsMenu = By.xpath("//select[contains(@data-fieldname,'account_level')]");
...
//    }
    ...
    public String getSelectedYearName() throws InterruptedException {
        waitUntilElementToBePresent(yearField_4, GeneralConstants.minTimeOut);
        getWebElement(yearField_4).click();
        getWebElement(yearField_4).clear();
        getWebElement(yearField_4).click();
        waitUntilElementToBePresent(chosenYear, GeneralConstants.minTimeOut);
//        Thread.sleep(threadTimeOut);
        String yearName = getWebElement(chosenYear).getText();
        System.out.println(" chosen year is " + yearName);
        getWebElement(chosenYear).click();

        return yearName;
    }
    public String getSelectedLevelName() {
        waitUntilElementToBePresent(levelField_4, GeneralConstants.minTimeOut);
        getWebElement(levelField_4).click();
    ...
    public String getTotalOpeningDebitBalance() {
        waitUntilOverlayDisappear(loadImage, GeneralConstants.freezeTimeOut);

        waitUntilElementToBePresent(totalOpeningDebitBalance, GeneralConstants.minTimeOut);
        System.out.println(" total Opening Debit balance is " + getWebElement(totalOpeningDebitBalance).getText());
        return getWebElement(totalOpeningDebitBalance).getText();
    }
    public void scrollInsideTable() throws InterruptedException {
        waitUntilOverlayDisappear(loadImage, GeneralConstants.freezeTimeOut);

//        waitUntilElementToBePresent(table, GeneralConstants.minTimeOut);
        for (int i = 0; i < 10; i++) {
            ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", getWebElement(totalOpeningDebitBalance));
            Thread.sleep(2000);
        }
    }
    public String getTotalOpeningCreditBalance() {
        waitUntilOverlayDisappear(loadImage, GeneralConstants.freezeTimeOut);

        waitUntilElementToBePresent(totalOpeningCreditBalance, GeneralConstants.minTimeOut);
        System.out.println(" total Opening credit balance is " + getWebElement(totalOpeningCreditBalance).getText());
        return getWebElement(totalOpeningDebitBalance).getText();
    }
    public String getTotalClosingCreditBalance() {
        waitUntilOverlayDisappear(loadImage, GeneralConstants.freezeTimeOut);

        waitUntilElementToBePresent(totalClosingCreditBalance, GeneralConstants.minTimeOut);
        System.out.println(" total closing credit balance is " + getWebElement(totalClosingCreditBalance).getText());
        return getWebElement(totalClosingCreditBalance).getText();
    }
    public String getTotalClosingDebitBalance() {
        waitUntilOverlayDisappear(loadImage, GeneralConstants.freezeTimeOut);

        waitUntilElementToBePresent(totalClosingDebitBalance, GeneralConstants.minTimeOut);
        System.out.println(" total closing debit balance is " + getWebElement(totalClosingDebitBalance).getText());
    ...
    public String getTotalDebitBalance() {
        ...
        System.out.println(" total debit balance is " + getWebElement(totalDebitBalance).getText());
    ...
    public String getTotalCreditBalance() {
        ...
        System.out.println(" total  credit balance is " + getWebElement(totalCreditBalance).getText());
    ...
    public void applyFilters_5(String companyName, String levelName) throws InterruptedException {
        waitUntilElementToBePresent(levelField_5,GeneralConstants.minTimeOut);
        getWebElement(levelField_5).click();
        Select levelsMenu = new Select(getWebElement(accountLevelsMenu));
                waitUntilOverlayDisappear(overlay, GeneralConstants.freezeTimeOut);
        ...
        waitUntilElementToBePresent(chosenCompany_5, GeneralConstants.freezeTimeOut);
        getWebElement(chosenCompany_5).click();
        System.out.println("enter chosen level  ");
        getWebElement(levelField_5).click();
        waitUntilElementToBePresent(accountLevelsMenu,GeneralConstants.minTimeOut);
        levelsMenu.selectByVisibleText(levelName);
//
//        waitUntilElementToBePresent(chosenLevel_5, GeneralConstants.minTimeOut);
//        Thread.sleep(threadTimeOut);
//        getWebElement(chosenLevel_5).click();
////
