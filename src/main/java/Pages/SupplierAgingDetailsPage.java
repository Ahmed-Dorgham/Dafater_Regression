...
public class SupplierAgingDetailsPage extends MainPage {
    ...
    public SupplierAgingDetailsPage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    private By listLabel = By.xpath("//h5[contains(text(),'القوائم المالية')]" +
            "| //h3[contains(text(),'الحسابات الدائنة ( الدائنون )')]");
    ...
    private By clearFilter = By.xpath("(//span[contains(@class,'ui-icon ui-icon-closethick')])");
    private By wareHouseInputField_5 = By.xpath("//*[contains(@data-fieldname,'warehouse')]/div/ul/li/input");
    private By chosenCompany = By.xpath("//li[contains(@role,'presentation')]//span[contains(@style,'font-weight: bold;')]");
...
//    }
    ...
    public void loadReportData_4() {
        Allure.step(" load supplier aging details report data at dafater 4 ");
    ...
    public String getInvoicedAmountValue() throws InterruptedException {
    ...
    public String getInvoicedAmountValue_4() throws InterruptedException {
        ...
        if (tryToGetWebElementV(invoicedAmountVal) == GeneralConstants.SUCCESS) {
            waitUntilElementToBeClickable(invoicedAmountVal, GeneralConstants.minTimeOut);
            invoicedAmountValue = getWebElement(invoicedAmountVal).getText();
            System.out.println("invoiced amount value at dafater 4 is " + getWebElement(invoicedAmountVal).getText());
    ...
    public String getOutstandingAmountValue() throws InterruptedException {
        ...
        waitUntilOverlayDisappear(loadImage, GeneralConstants.minTimeOut);
        if (tryToGetWebElementP(outstandingAmountVal) == GeneralConstants.SUCCESS) {
//            waitUntilElementToBeClickable(outstandingAmountVal, GeneralConstants.minTimeOut);
            outstandingAmountValue = getWebElement(outstandingAmountVal).getAttribute("textContent");
            System.out.println("outstanding amount value at dafater 5 is " + getWebElement(outstandingAmountVal).getAttribute("textContent"));
            Allure.step("outstanding amount value at dafater 5 is " + getWebElement(outstandingAmountVal).getAttribute("textContent"));
    ...
    public String getOutstandingAmountValue_4() throws InterruptedException {
        String outstandingAmountValue = null;
        waitUntilOverlayDisappear(loadImage, GeneralConstants.minTimeOut);
        if (tryToGetWebElementP(outstandingAmountVal) == GeneralConstants.SUCCESS) {
//            waitUntilElementToBeClickable(outstandingAmountVal, GeneralConstants.minTimeOut);
            outstandingAmountValue = getWebElement(outstandingAmountVal).getAttribute("textContent");
            System.out.println("outstanding amount value at dafater 4 is " + getWebElement(outstandingAmountVal).getAttribute("textContent"));
            Allure.step("outstanding amount value at dafater 4 is " + getWebElement(outstandingAmountVal).getAttribute("textContent"));
            return outstandingAmountValue;
        } else {
    ...
    public String getSelectedYearName() throws InterruptedException {
        ...
        waitUntilElementToBePresent(clearFilter, GeneralConstants.minTimeOut);
        getWebElement(clearFilter).click();
...
//        Thread.sleep(threadTimeOut);
    ...
    public String getSelectedPeriodName() throws InterruptedException {
        waitUntilElementToBePresent(periodField_4, GeneralConstants.minTimeOut);
        getWebElement(periodField_4).click();
...
//        Thread.sleep(threadTimeOut);
    ...
    public String selectBalanceSheetReport() throws InterruptedException {
        waitUntilElementToBePresent(listLabel, GeneralConstants.minTimeOut);
        waitUntilElementToBeClickable(listField_4, GeneralConstants.minTimeOut);
        getWebElement(listField_4).click();
...
//        Thread.sleep(threadTimeOut);
    ...
    public String selectProfitAndLossReport() throws InterruptedException {
        waitUntilElementToBePresent(listLabel, GeneralConstants.minTimeOut);
        waitUntilElementToBeClickable(listField_4, GeneralConstants.minTimeOut);
        getWebElement(listField_4).click();
...
//        waitUntilElementToBePresent(table, GeneralConstants.minTimeOut);
        for (int i = 0; i < 20; i++) {
            ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", getWebElement(profitOrLossField));
            Thread.sleep(500);
        }
    }
    ...
    public void applyFilters_5(String companyName) throws InterruptedException {
        waitUntilElementToBePresent(listLabel, GeneralConstants.minTimeOut);
    ...
    public String getPeriodOptionName() {
        Select periodsMenu = new Select(getWebElement(periodsOptions));
        getWebElement(periodsOptions).click();
