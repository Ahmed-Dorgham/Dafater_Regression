...
public class ProfitAndLossReportPage extends MainPage {
    private String dataMigrationTitle = "data migration";
    // private WebDriver driver ;

    public ProfitAndLossReportPage(WebDriver driver) {
        this.driver = driver;
    }
...
//    }
    ...
    public void loadReportData_4() {
        System.out.println(" load balance sheet report data at dafater 4 ");
    ...
    public void loadReportData_5() {
        System.out.println(" load balance sheet report data  at dafater 5");
...
//        Thread.sleep(threadTimeOut);
        ...
        System.out.println(" chosen period is " + periodName);
...
//        Thread.sleep(threadTimeOut);
        ...
        System.out.println(" chosen report is " + listName);
...
//        waitUntilElementToBePresent(table, GeneralConstants.minTimeOut);
    ...
    public String applyFilters_5(String companyName, String yearName) throws InterruptedException {
        ...
        Select filtrationDependOn = new Select(getWebElement(filterationDependOnOptions));
        ...
        System.out.println(" chosen filtration is  " + filtrationBasedOnOption);

        waitUntilElementToBePresent(fiscalYearInputField, GeneralConstants.minTimeOut);
        getWebElement(fiscalYearInputField).click();
        getWebElement(fiscalYearInputField).clear();

        getWebElement(fiscalYearInputField).sendKeys(yearName);

        return filtrationBasedOnOption;
    }
