...
//    }
    ...
    public String getDefaultDebitAccount() throws InterruptedException {
        ...
        waitUntilElementToBePresent(viewBtn, GeneralConstants.minTimeOut);
        waitUntilOverlayDisappear(overlay, GeneralConstants.freezeTimeOut);
        System.out.println("open accounts tab  ");
...
//        Thread.sleep(threadTimeOut);
        ...
        System.out.println("default credit account name is  " + getWebElement(defaultCreditAccountInputField).getText());
    ...
    public String getDefaultIncomeAccount() throws InterruptedException {
        System.out.println("click on close tab ");
//        waitUntilOverlayDisappear(overlay, GeneralConstants.freezeTimeOut);
        waitUntilElementToBePresent(viewBtn, GeneralConstants.minTimeOut);
        waitUntilOverlayDisappear(overlay, GeneralConstants.freezeTimeOut);
...
//        waitUntilOverlayDisappear(overlay, GeneralConstants.freezeTimeOut);
        ...
        System.out.println("default expense account name is  " + getWebElement(defaultExpenseAccountInputField).getText());
