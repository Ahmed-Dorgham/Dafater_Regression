...
public class ReceiptVouchersListPage extends MainPage {
    private String dataMigrationTitle = "data migration";
    // private WebDriver driver ;

    public ReceiptVouchersListPage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    private By receiptVoucherLabel = By.xpath("//h3[contains(@title,'سندات الدفع')]");
...
//                System.out.println(sumOfTotalOutstandingAmountValues);
    ...
    public ReceiptVoucherPage clickOnNewReceiptVoucherBtn() {
        Allure.step("click on new Receipt Voucher btn ");
        waitUntilOverlayDisappear(overlay, GeneralConstants.freezeTimeOut);
        waitUntilElementToBePresent(receiptVoucherLabel, GeneralConstants.minTimeOut);
